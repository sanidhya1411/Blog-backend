...
const ForgotPassword = async (req, res, next)=>{
    ...
    try{
        ...
        let info = await transporter.sendMail({ 
            ...
            <a href="https://blog-app-liard-zeta.vercel.app/reset-password/${ptoken}">Click Here</a>
...
module.exports = { registerUser, loginUser, getUser, editUser, getAuthors, changeAvatar, ResetPassword ,ForgotPassword,verifiedMail,verifyMail}
